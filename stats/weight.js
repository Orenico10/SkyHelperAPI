...
module.exports = async (player, profile) => {
    const { skills_levels, skills_experience } = formatLilySkills(getSkills(player, profile, true));
    ...
    return {
        senither: {
            ...
            slayer: {
                ...
                weight_overflow: senither.slayer.revenant.weight_overflow + senither.slayer.tarantula.weight_overflow + senither.slayer.sven.weight_overflow + senither.slayer.enderman.weight_overflow,
                slayer: {
                    revenant: {
...
function formatLilySkills(skills) {
    ...
    const skills_experience = whitelistedSkills.sort((a, b) => skillSort.indexOf(a) - skillSort.indexOf(b)).map((skill) => skills[skill].totalXp);
