...
class Elephant extends Pet {
  ...
  get third() {
    ...
    return {
      ...
      desc: [
        `§7Grants §a+${round(this.level * mult, 1)} §6${symbols.farming_fortune.symbol
...
class Armadillo extends Pet {
  ...
  get fifth() {
    ...
    return {
      name: "§6Mobile Tank",
      desc: [
        `§7For every §a${round(100 - this.level * mult, 1)} §7Defense, gain §f+1 ${symbols.speed.symbol} Speed §7and §6+1 ${symbols.mining_speed.symbol
        } Mining Speed`,
      ],
    };
  }
...
class EnderDragon extends Pet {
  ...
  get second() {
    return {
      ...
      desc: [
        `§7Buffs the Aspect of the Dragons sword by §a${round(this.level * 0.5, 1)} §c${symbols.strength.symbol
...
class Guardian extends Pet {
  ...
  get first() {
    ...
    return {
      name: "§6Lazerbeam",
      desc: [
        `§7Zap your enemies for §b${round(this.level * mult, 1)}x §7your §b${symbols.intelligence.symbol
...
class Phoenix extends Pet {
  ...
  get first() {
    ...
    return {
      name: "§6Rekindle",
      desc: [
        `§7Before death, become §eimmune §7and gain §c${start_strength + round(this.level * mult_strength, 1)} ${symbols.strength.symbol
  ...
  get second() {
    ...
    return {
      name: "§6Fourth Flare",
      desc: [
        `§7On 4th melee strike, §6ignite §7mobs, dealing §c${1 + round(this.level * mult_damage, 1)}x §7your §9${symbols.crit_damage.symbol
...
class Pigman extends Pet {
  ...
  get second() {
    ...
    return {
      name: "§6Pork Master",
      desc: [
        `§7Buffs the Pigman sword by §a${round(this.level * mult_damage, 1)} §c${symbols.strength.symbol
...
class Rat extends Pet {
  ...
  get third() {
    ...
    return {
      ...
      desc: [
        `§7Has a chance to grant a random player §b+${floor(2 + this.level * mult_mf, 1)} ${symbols.magic_find.symbol
...
class Turtle extends Pet {
  ...
  get second() {
    ...
    return {
      ...
      desc: [
        `§7Grants §a+${round(5 + this.level * mult, 1)} ${symbols.defense.symbol
...
class Wolf extends Pet {
  ...
  get second() {
    ...
    return {
      name: "§6Pack Leader",
      desc: [
        `§7Gain §a${round(this.level * mult, 1)} §9 ${symbols.crit_damage.symbol
...
class Lion extends Pet {
  ...
  get first() {
    ...
    return {
      name: "§6Primal Force",
      desc: [
        `§7Adds §c+${round(this.level * mult, 1)} ${symbols.strength.symbol} Damage §7and §c+${round(this.level * mult, 1)} ${symbols.strength.symbol
...
class Monkey extends Pet {
  ...
  get first() {
    ...
    return {
      name: "§6Treeborn",
      desc: [
        `§7Grants §a+${round(this.level * mult, 1)} §6${symbols.foraging_fortune
...
class BabyYeti extends Pet {
  ...
  get first() {
    ...
    return {
      name: "§6Cold Breeze",
      desc: [
        `§7Gives §a${round(this.level * mult, 1)} §c${symbols.strength.symbol} Strength §7and §9${symbols.crit_damage.symbol
  ...
  get third() {
    ...
    return {
      name: "§6Yeti Fury",
      desc: [
        `§7Buff the Yeti sword by §a${round(this.level * mult, 1)} §c${symbols.strength.symbol} Damage §7and §9${symbols.intelligence.symbol
        } Intelligence`,
      ],
    };
  }
...
class BlueWhale extends Pet {
  ...
  get second() {
    ...
    return {
      name: "§6Bulk",
      desc: [
        `§7Gain §a${round(this.level * mult, 1)} ${symbols.defense.symbol} Defense §7per §c${health} Max ${symbols.health.symbol
        } Health`,
      ],
    };
  }
...
class Ammonite extends Pet {
  ...
  get first() {
    ...
    return {
      ...
      desc: [
        `§7Each Heart of the Mountain level grants §3+${round(this.level * mult, 1)} ${symbols.sea_creature_chance.symbol
        } Sea Creature Chance`,
      ],
    };
  }
  ...
  get second() {
    ...
    return {
      name: "§6Not a Snail",
      desc: [
        `§7Each fishing and mining level grants §f+${round(this.level * mult, 1)} ${symbols.speed.symbol
...
class FlyingFish extends Pet {
  ...
  get second() {
    ...
    return {
      ...
      desc: [
        `§7Gives §a${round(this.level * mult, 1)} §c${symbols.strength.symbol} Strength §7and §a${symbols.defense.symbol
...
class Megalodon extends Pet {
  ...
  get first() {
    ...
    return {
      name: "§6Blood Scent",
      desc: [
        `§7Deal up to §c+${round(mult * this.level, 1)}% ${symbols.strength.symbol
  ...
  get third() {
    ...
    return {
      ...
      desc: [
        `§7On kill gain §c${round(mult * this.level, 1)} ${symbols.strength.symbol} Damage §7and §f${symbols.speed.symbol
  ...
  get second() {
    ...
    return {
      ...
      desc: [
        ...
        !maxTier
          ? `§7Next Upgrade: §a+${next.defense} ${symbols.defense.symbol} §7& §f+${next.true_defense} ${symbols.true_defense.symbol
...
class MooshroomCow extends Pet {
  ...
  get third() {
    ...
    return {
      ...
      desc: [
        `§7Gain §6+1 ${symbols.farming_fortune.symbol} Farming Fortune §7per every §c${round(40 - this.level * mult, 1)} ${symbols.strength.symbol
        } Strength`,
      ],
    };
  }
...
class Snail extends Pet {
  ...
  get second() {
    ...
    return {
      name: "§6Slow Moving",
      desc: [
        `§7Converts all §f${symbols.speed.symbol} Speed §7over 100 into §6${symbols.mining_fortune.symbol
  ...
  get third() {
    ...
    return {
      ...
      desc: [
        `§7Reduces the mana cost of §9Utility Abilities §7by §a${round(this.level * mult, 1)}% §7for every +15 §f${symbols.speed.symbol
        } Speed §7converted`,
      ],
    };
  }
